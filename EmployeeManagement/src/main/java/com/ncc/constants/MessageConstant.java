...
public class MessageConstant {
    ...
    public static final String COMPANY_BRANCH_IS_NULL = "Company Branch is null";
    public static final String LIST_EMPLOYEE_IS_EMPTY = "List Employee is Empty";
    public static final String OPEN_TALK_TOPIC_IS_NULL = "OpenTalk Topic is Null";

    public static final String OPEN_TALK_TOPIC_OR_EMPLOYEE_IS_NULL = "OpenTalk Topic or Employee is Null";
    public static final String COMPANY_BRANCH_OR_ROLE_IS_NULL = "Company Branch or Role is Null";
